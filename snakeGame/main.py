...
class Food:
    def __init__(self):
        x = random.randint(0, int (GAME_WIDTH / SPACE_SIZE) - 1) * SPACE_SIZE  # 700/50 = 14
...
def game_over():
    ...
    window.after(1000, show_restart_button)

def show_restart_button():
    restart_button = Button(canvas, text='Restart', font=('consolas', 20), command=restart_game ,bg='gray')

    #place the button on the canvas
    canvas.create_window(GAME_WIDTH/2, GAME_HEIGHT/2, window=restart_button,tag= "gameover")
